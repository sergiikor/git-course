...
## 1. Генерація SSH-ключа локально
...
## 2. Додавання SSH-ключа до агента SSH
...
## 6. Ініціалізація локального Git-репозиторію
...
## 7. Додавання віддаленого репозиторію
...
## 9. Усунення помилки "Updates were rejected"
